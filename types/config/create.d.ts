...
import type { AdvancedSearchDateTimePickerExtra, AdvancedSearchDateTimeRangePickerExtra, AdvancedSearchSelectExtra, AdvancedSearchStringExtra } from "./advancedSearch";
...
export interface EditForm<Row, Type extends keyof EditFormExtraMap<Row> = BaseFormType> {
    field: keyof Row;
    title: string;
    type: Type;
    tooltipText?: string;
    placeholder?: boolean | string | ((value: Row) => string);
 ...
 * for string
 */
export declare type EditFormStringExtra = AdvancedSearchStringExtra;
/**
 * for select
 */
export declare type EditFormSelectExtra = AdvancedSearchSelectExtra;
/**
 * for cascader
 */
 ...
 */
export declare type EditFormDateTimePickerExtra = AdvancedSearchDateTimePickerExtra;
/**
 * for date-range-picker/time-range-picker/date-time-range-picker
 */
export declare type EditFormDateTimeRangePickerExtra = AdvancedSearchDateTimeRangePickerExtra;
/**
 * for remote-search
 */
